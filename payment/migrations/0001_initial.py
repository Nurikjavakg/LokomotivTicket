    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skating_status', models.CharField(choices=[('WAITING', 'Ожидает'), ('IN_PROGRESS', 'В процессе'), ('TIME_EXPIRED', 'Время вышло'), ('FINISHED', 'Завершен')], default='WAITING', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('status', models.CharField(choices=[('WAITING', 'Ожидает'), ('IN_PROGRESS', 'В процессе'), ('TIME_EXPIRED', 'Время вышло'), ('FINISHED', 'Завершен')], default='WAITING', max_length=20)),
